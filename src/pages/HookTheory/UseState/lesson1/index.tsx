...
const UseStateLesson1: React.FC = () => {
    ...
    return(<Typography>
        ...
        <Paragraph>
            <Text code>{'function useState<S>(initialState: (() => S) | S,): [S, Dispatch<BasicStateAction<S>>] {\n' +
        ...
        <Paragraph>
            ...
            <Link href="https://react.docschina.org/docs/hooks-rules.html" target="_blank">
                React文档
            </Link>
            ...
            这让 React 能够在多次的<Text code>useState</Text> 和 <Text code>useEffect</Text> 调用之间保持 hook 状态的正确。
